...
SceneGraphNode* Converter::convert(Model *m)
{
    ...
    //Edge 3
    TransformNode* positionEdge3 = new TransformNode(new Transform(TRANSLATE, 0.0f, EDGE_DISTANCE_FROM_ORIGIN, 0.0f), new Transform(ROTATE, 45.0f, 1.0f, 0.0f, 0.0f), new Transform(ROTATE, -90.0f, 0.0f, 1.0f, 0.0f));
    ...
    //Edge 10
    TransformNode* positionEdge10 = new TransformNode(new Transform(TRANSLATE, 0.0f, EDGE_DISTANCE_FROM_ORIGIN, 0.0f), new Transform(ROTATE, 135.0f, 1.0f, 0.0f, 0.0f), new Transform(ROTATE, 180.0f, 0.0f, 1.0f, 0.0f));
